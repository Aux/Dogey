...
//            set { _msgs = value; }
//        }
//        private string _msgs { get; set; }
//        #endregion

//        [NotMapped]
//        public List<string> Tags
//        {
//            get { return JsonConvert.DeserializeObject<List<string>>(_tags); }
...
//        {
//            get { return JsonConvert.DeserializeObject<List<string>>(_msgs); }
//            set { _msgs = JsonConvert.SerializeObject(value); }
//        }
...
//            string text = parts[0].Substring(prefix.Count());
...
//            } else
//            {
//                Console.WriteLine($"{cmd.Id} {cmd.Name} / {cmd.Tags.Count()} {cmd.tags} / {cmd.Messages.Count()} {cmd.msgs}");
//                switch (cmd.Type)
//                {
